  ...
  return (
    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-5 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb:[6rem}">
          <h1 className="h1 mb-6">
            Explore teh Possibilites of &nbsp;AI&nbsp;Chatting with Brainwave
          ...
          <p className="body-1 max-w-3xl mb-6 text-n-2 lg:mb-8">
            Unleash the power of the AI within Brainwave. Upgrade your
